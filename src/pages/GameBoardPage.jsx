            ...
            <div className="max-w-md mx-auto w-full flex flex-col items-center gap-stack-md">
              ...
              {primaryOpponent && (
                <button
                  ...
                  className={`${isFourPlayerSocial ? '' : isOneVsOne ? 'mt-3 sm:mt-4' : '-mt-4 sm:-mt-3'} w-full max-w-xs bg-secondary text-on-secondary font-headline-sm text-headline-sm px-4 py-4 ${isOneVsOne ? 'rounded-full shadow-[0_6px_20px_rgba(233,179,255,0.28)] transition-transform duration-150 ease-out motion-reduce:transition-none' : 'rounded-lg shadow-[0_0_20px_rgba(233,179,255,0.4)] hover:shadow-[0_0_30px_rgba(233,179,255,0.6)] transition-all'} active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:shadow-none flex items-center justify-center gap-2 uppercase tracking-wider min-h-[52px] text-center leading-tight` }
                >
